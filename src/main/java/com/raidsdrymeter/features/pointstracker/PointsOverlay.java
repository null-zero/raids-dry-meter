...
import com.raidsdrymeter.module.PluginLifecycleComponent;
...
public class PointsOverlay extends OverlayPanel implements PluginLifecycleComponent
{
	...
	private final RaidsDryMeterConfig config;

	@Inject
	public PointsOverlay(OverlayManager overlayManager, RaidsDryMeterConfig config, PointsTracker pointsTracker, PartyPointsTracker partyPointsTracker)
	{
	...
	@Override
	public boolean isEnabled(RaidsDryMeterConfig config, RaidState raidState)
	{
